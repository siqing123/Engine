...
void GameState::Initialize()
{
	...
	const char* modelFileName = "../../Assets/Models/Dancing/Dancing.model";
	...
	//mHuman.transform.position = mPosition;
...
void GameState::DebugUI()
{
	...
	//{
	//	ImGui::DragFloat3("Position", (float*)&mHuman.transform.position, 0.1f);
